...
//            }
        ...
        g.drawString(df.format(getLowValue()) + "", minX, rect.y + TOP_OFFSET);
        g.drawString(df.format(getHighValue()) + "", maxX-g.getFontMetrics().stringWidth(df.format(getHighValue()) + ""), rect.y + TOP_OFFSET);
